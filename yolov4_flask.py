...
model = 'model/yolov4_ders_lastt.weights'
config = r'data/yolov4_ders.cfg'
labelsPath = r"data/yolov4_ders.names"
...
def v4_inference(frame):
    ...
    label = 'Cikarim Zamani: %.2f ms' % (t * 1000.0 / cv2.getTickFrequency())
    print(label)
